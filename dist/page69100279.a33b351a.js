...
function t_throttle(t, e, n) {
    ...
    return e || (e = 250), function() {
        var r = n || this, a = +new Date, l = arguments;
...
function t_onFuncLoad(t, e, n) {
    var o = 15e3, i = t_checkIsEditMode(), r = function t() {
    ...
    if (a(t) && r()) e();
        ...
        var l = Date.now(), d = new Error(t + " is undefined"), s = function t() {
            throw d;
        };
...
function t_checkIsEditMode() {
    var t = !1, e = document.getElementById("allrecords");
    if (!e) return !1;
...
function t_scrollBarWidthCompensator__setObject() {
    ...
    n = Array.prototype.filter.call(n, function(t) {
        ...
        if (!e.classList.contains("t975")) {
            var n = window.getComputedStyle(e), o = n.getPropertyValue("position"), i = n.getPropertyValue("width"), r = n.getPropertyValue("height"), a = "100%" === i || i === window.innerWidth + "px" || i === window.innerWidth - t.scrollBarWidth + "px" || "100vw" === i, l = "100%" === r || r === window.innerHeight + "px" || r === window.innerHeight - t.scrollBarWidth + "px" || "auto" === r || "100vh" === r;
        ...
        if (t.scrollBarWidth = Math.abs(window.innerWidth - document.documentElement.clientWidth), t.cancelTimeout && (window.clearTimeout(t.cancelTimeout), t.cancelTimeout = null), !t.isInited && t.scrollBarWidth) {
            ...
            Array.prototype.forEach.call(t.fixedElements, function(e) {
                ...
                if (document.body.contains(n) && !n.classList.contains("t975") && !n.classList.contains("t975")) {
                    var i = e.computedStyle, r = i.getPropertyValue("position");
                    if ("fixed" === r || "absolute" === r) {
                        ...
                        var d = i.getPropertyValue("width"), s = i.getPropertyValue("height"), c = n.style.right;
                        c && n.setAttribute("data-tilda-initial-right", c);
                        var u = n.style.width;
                        u && n.setAttribute("data-tilda-initial-width", u);
                        var m = "100%" === d || d === window.innerWidth + "px" || d === window.innerWidth - t.scrollBarWidth + "px" || "100vw" === d, h = "100%" === s || s === window.innerHeight + "px" || s === window.innerHeight - t.scrollBarWidth + "px" || "auto" === s || "100vh" === s;
...
function t_scrollBarWidthCompensator__cancel() {
    ...
    t && t.isInited && (t.isInited = !1, t.delay = 0, document.body.hasAttribute("data-tilda-initial-padding-right") ? (document.body.style.paddingRight = document.body.getAttribute("data-tilda-initial-padding-right"), document.body.removeAttribute("data-tilda-initial-padding-right")) : document.body.style.removeProperty("padding-right"), document.body.style.removeProperty("height"), document.body.style.removeProperty("min-height"), document.body.style.removeProperty("overflow"), Array.prototype.forEach.call(t.fixedElements, function(t) {
        var e = t.el, n = e.classList.contains("tn-atom__sticky-wrapper") || e.classList.contains("tn-atom__sbs-anim-wrapper");
...
function t_loadJsFile(t, e, n) {
    ...
    if (document.querySelector('script[src^="' + t + '"]')) e && e();
        ...
        r.type = "text/javascript", r.src = t, e && r.addEventListener("load", function() {
            e();
        }), r.addEventListener("error", function(o) {
            if (!(n <= 3)) {
                var a = o.message || "<no error message>";
                throw new Error("Failed to load " + t + " script: " + a, {
                    cause: o
                });
            }
            setTimeout(function() {
...
function t_loadCSSFile(t, e, n) {
    ...
    if (document.querySelector('link[href^="' + t + '"]')) e && e();
        ...
        r.rel = "stylesheet", r.type = "text/css", r.media = "all", r.href = t, r.crossOrigin = "anonymous", e && r.addEventListener("load", e), r.addEventListener("error", function(o) {
            if (!(n <= 3)) {
                var a = o.message || "<no error message>";
                throw new Error("Failed to load " + t + " style: " + a, {
                    cause: o
                });
            }
            setTimeout(function() {
...
function t_scrollTo(t, e) {
    if (t) {
        var n = e || {}, o = n.useNativeScrollTo, i = n.duration, r = n.behavior, a = void 0 === r ? "instant" : r, l = n.offset, d = void 0 === l ? 0 : l, s = Math.max(parseInt(t.getBoundingClientRect().top + window.scrollY - d, 10), 0);
...
function t_smoothScrollTo(t, e) {
    void 0 === e && (e = 500);
    var n = document.body, o = window.scrollY || window.pageYOffset, i = t - o, r = performance.now();
    function a(t) {
        return Math.pow(t, 2);
    }
    function l() {
        var d = performance.now(), s = Math.min((d - r) / e, 1), c = a(s);
...
window.browserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.tildaBrowserLang = window.browserLang, t_onReady(function() {
    ...
    var t = window.navigator.userAgent, e = -1 !== t.indexOf("Instagram"), n = -1 !== t.indexOf("FBAV"), o = -1 !== t.indexOf("YaSearchBrowser"), i = -1 !== t.indexOf("SamsungBrowser"), r = -1 !== t.indexOf("DuckDuckGo"), a;
    ...
    setTimeout(function() {
        var e = document.querySelector("html"), n = document.querySelector(".t-tildalabel"), o = e.offsetHeight;
    ...
    if (!window.isMobile && t && "yes" !== t.getAttribute("data-blocks-animationoff") && !1 === window.isSearchBot) {
        ...
        for(var r = Array.prototype.slice.call(e).filter(function(t) {
            ...
            var o, a = (o = r[n]).getBoundingClientRect().top + window.pageYOffset, l = window.pageYOffset + window.innerHeight + 300;
        ...
        if (r.length) {
            function d() {
                for(var t = r.length - 1; t >= 0; t--){
                    var e = r[t], n, o = 0;
                    e.getBoundingClientRect().top + window.pageYOffset < (o = e.offsetHeight <= 100 ? window.pageYOffset + window.innerHeight : window.pageYOffset + window.innerHeight - 100) && (t_removeClass(e, "r_hidden"), t_addClass(e, "r_showed"), (r = Array.prototype.slice.call(r)).splice(t, 1));
                }
            }
            var s = document.querySelectorAll('[data-record-type="400"]');
            if (s.length > 0) var c = 0, u = 0, m = setInterval(function() {
    ...
    var h = document.querySelector("html"), p = document.body;
    ...
    function e() {
        var t = window.isMobile ? document.documentElement.clientWidth : window.innerWidth, e = document.querySelectorAll(".r[data-screen-max], .r[data-screen-min]"), n, o, i;
        -1 !== navigator.userAgent.indexOf("Instagram") && (t = screen.width);
        for(var r = 0; r < e.length; r++){
            var a = e[r], l = a.id.replace("rec", "");
            if ("yes" === a.getAttribute("data-connect-with-tab") || document.querySelector('[data-popup-rec-ids="' + l + '"]')) return;
            i = getComputedStyle(a).display, (n = a.getAttribute("data-screen-max")) || (n = 1e4), (o = a.getAttribute("data-screen-min")) || (o = 0), n = parseInt(n), (o = parseInt(o)) <= n && (t <= n && t > o ? "block" !== i && (a.style.display = "block") : "none" !== i && (a.style.display = "none"));
        }
    }
    t_onReady(function() {
    ...
    function e() {
        for(var t = document.querySelectorAll(".t-cover__carrier"), e = 0, n = 0; n < t.length; n++){
            ...
            if ((i = (o = t[n]).style).height.indexOf("vh") > -1) {
                ...
                var a = document.getElementById("tempDiv"), l = parseInt(getComputedStyle(a).height.replace("px", ""));
                t_removeEl(a);
                var d = Math.round(l * e) + "px", s = o.closest(".t-cover");
                if (s) {
                    var c = s.querySelector(".t-cover__filter"), u = s.querySelector(".t-cover__wrapper");
                    s.style.height = d, c && (c.style.height = d), u && (u.style.height = d);
                }
                i.height = d;
            }
        }
        var m = document.querySelectorAll("[data-height-correct-vh]"), h = window.innerHeight;
        e = 0;
    ...
    function n() {
        ...
        for(var n = document.querySelectorAll('.r:not([data-record-type="396"]):not([data-record-type="1003"])'), o = [], i = 0; i < n.length; i++){
            var r = n[i], a = getComputedStyle(r);
    ...
    function o(t) {
        for(var e = document.querySelectorAll('.t-text:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-name:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-title:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-descr:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-heading:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-text-impact:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-subtitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"]), .t-uptitle:not(.tn-elem):not(.tn-atom):not([data-auto-correct-line-height="false"])'), n = 0; n < e.length; n++){
            var o = e[n], i = o.getAttribute("style");
            if (i) {
                var r = "rem" === o.getAttribute("data-auto-correct-font-size"), a;
    ...
    setTimeout(function() {
        for(var t = document.querySelectorAll('a[href^="http"][target="_blank"]'), e = 0; e < t.length; e++){
            var n = t[e], o = n.getAttribute("rel") || "";
...
//# sourceMappingURL=page69100279.a33b351a.js.map

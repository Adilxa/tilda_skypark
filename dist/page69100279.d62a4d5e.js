...
var t_formsApi__safeFocus = function t(e) {
    ...
    var r = e.dataset, o = r.inputLid, n = r.fieldType, a = r.fieldName, i = r.fieldAsync, s = r.defaultValue, l;
    return {
        lid: o,
        fieldType: n,
    ...
    return new Promise(function(t) {
        ...
        e.data.isAsync && !o ? e.element.addEventListener("inputReady", r, {
            once: !0
        }) : r();
    });
    ...
    var i = function t() {
        ...
        reset: function t() {
            var e = i(), o = r.defaultValue || "";
            t_formsApi__safeSetValue(e, o, {
                silent: !0
            });
        },
    ...
    return e.addEventListener("change", _), e.t_field = f, f;
    ...
    return e.data.inputs = Array.from(e.element.querySelectorAll('[type="radio"]')), e.getValue = function() {
        ...
        return {
            value: t_formsApi__safeValue(t)
        };
    }, e.reset = function() {
        var t = Number(e.data.defaultValue), r = null != t && t > 0;
    ...
    return e.onFieldReady = function() {
        return t_formsApi__waitForFieldReadyState(e).then(function() {
            var t = e.element.querySelector(".t-radio-ownanswer, .t-checkbox-ownanswer"), r = t ? t.getAttribute("data-own-variant-title") : "";
            return e.data.ownVariantInput = t, e.data.ownVariantTitle = r, e;
        });
    }, e;
}, t_formsApi__checkboxesMixin = function t(e) {
    return e.data.inputs = Array.from(e.element.querySelectorAll('[type="checkbox"]')), e.focus = function() {
        var t = e.element.querySelector('[type="checkbox"]');
        t_formsApi__safeFocus(t);
    }, e.reset = function() {
        var t = e.element.querySelector('[name="' + e.data.fieldName + '"]'), r = Number(e.data.defaultValue), o = null != r && r > 0;
        t_formsApi__safeSetValue(t, "", {
            silent: !0
        }), e.data.ownVariantInput && t_formsApi__sendReset(e.data.ownVariantInput), e.data.inputs.forEach(function(t) {
            return t.checked = !1;
        ...
        return r.onFieldReady = function() {
            return new Promise(function(t) {
                t_onFuncLoad("uploadcare", function() {
                    r.data.widget = window.uploadcare.Widget('[data-input-lid="' + r.data.lid + '"] [role="uploadcare-uploader"]'), r.data.widget.onUploadComplete.add(function() {
                        return t_formsApi__sendChange(r.element);
                    }), t(r);
                });
            });
            ...
            var t = r.data.widget;
            t_formsApi__safeSetValue(t.inputElement, "", {
                silent: !0
            }), t.reloadInfo();
        }, r;
    } catch (o) {
    ...
    var i, s = Array.from(e.querySelectorAll(".t-contact-method__type")).map(function(t) {
        ...
        return {
            wrapper: t,
            input: e,
            displayText: t.textContent.trim()
        };
    });
    return r.getValue = function() {
        var t, o = t_formsApi__safeValue(e.querySelector('[name="' + r.data.idInputName + '"]:not([disabled])')), n = s.find(function(t) {
            return t.input.checked;
        }), a = t_formsApi__safeValue(n.input), i = n ? n.displayText : "";
        return {
            value: (t = {}, t[r.data.idInputName] = {
                value: o
            }, t[r.data.typeInputName] = {
                value: a,
                typeInputDisplayText: i
            }, t)
        };
    }, r.focus = function() {
        var t, e = r.element.querySelector(".t-contact-method__value-container > :not(.t-contact-method__hidden)").querySelector(".t-input-block:not(.t-contact-method__hidden)"), o = e.querySelector(".js-username-input");
    ...
    return r.getValue = function() {
        ...
        return {
            value: t && t.checked ? "yes" : "no"
        };
    }, r.reset = function() {
        var t = e.querySelector('[name="' + r.data.fieldName + '"]'), o = r.data.defaultValue;
        t.checked = "y" === o;
    }, r;
    ...
    var r = t_formsApi__radioFieldMixin(t_formsApi__getTildaField(e)), o = r.reset;
    return r.reset = function() {
        for(var t = arguments.length, e = new Array(t), n = 0; n < t; n++)e[n] = arguments[n];
        o.call.apply(o, [
            this
        ].concat(e)), t_formsApi__sendReset(r.element);
    }, r;
    ...
    try {
        var r = t_formsApi__getTildaField(e), o = r.element.querySelector('[name="' + r.data.fieldName + '"]');
        return r.reset = function() {
            if (o) {
                var t = o.options[0], e = t && "" === t.value, n = Number(r.data.defaultValue) || 0, a = Math.max(0, e ? n : n - 1), i;
    ...
    return _catch$1(function() {
        ...
        var e = t.closest(".t-rec"), r, o = Array.from(t.querySelectorAll(".t-input-group")).map(t_formsApi__initTildaField);
        return _await$1(Promise.allSettled(o), function(r) {
            ...
            r.filter(function(t) {
                ...
                return t.value;
            }).sort(t_formsApi__sortFieldsBeforeClear).forEach(function(t) {
                return t.reset && t.reset();
            }), t_formsApi__isConditionalForm(t) && e.dispatchEvent(new CustomEvent("sync-conditionals", {
                detail: {
                    shouldPreventSubmit: !1
                }
            }));
        });
    }, function(t) {
...
var t_forms__updateAllVariables = _async(function(t) {
    return _continueIgnored(_catch(function() {
        var e = t.closest(".t-rec"), r = t_forms__getUsedVariables([
            e
        ], {
            unique: !0
        }), o;
        ...
        var n, a = r.filter(function(t) {
            return !t_forms__isSystemVariable(t);
        }).map(_async(function(t) {
            var r = t_forms__findFormField(e, t.name);
            return r ? _await(t_formsApi__initTildaField(r), function(r) {
...
function t_forms__setupCloseHandlers(t, e) {
    var r = document.body, o = t.querySelector(".t-form-success-popup__close-icon"), n = document.getElementById("tildaformsuccesspopupbtn-new");
    function a() {
    ...
    window.tildaForm.currentRemoveCloseHandlers = a, o && o.addEventListener("click", window.tildaForm.handleClosePopup), n && n.addEventListener("click", window.tildaForm.handleClosePopup), e || (r.addEventListener("keydown", i), t.addEventListener("click", s));
}
function t_forms__initForms() {
    ...
    window.t_forms__inputData = {}, t_forms__addRecaptcha(), Array.prototype.forEach.call(t, function(t) {
        var e = t.id;
        if (!window.initForms[e]) {
            t_forms__initFormFields(t), t_forms__initEventPlaceholder(t), t_forms__addInputItsGood(t), t_forms__addAttrAction(t), t_forms__onSubmit(t), t_forms__onClick(t), t_forms__onRender(t), t_forms__addFocusOnTab(t), t_onFuncLoad("t_throttle", function() {
                window.addEventListener("resize", t_throttle(function() {
                    t_forms__calculateInputsWidth(e);
                }));
            }), window.initForms[e] = !0;
            var r = t.querySelector(".t-form"), o;
            if (r && t_forms__isNewSuccessBox(r)) r.setAttribute("data-success-popup", "y"), r.querySelector(".t-form__successbox").classList.add("t-form-success-popup");
        }
    });
}
function t_forms__validateOwnVariant(t) {
    var e;
    t && (t.value && (t.value = ""), t.closest(".tn-atom__form") || (t.timerID && clearTimeout(t.timerID), t.timerID = setTimeout(function() {
...
function t_forms__removePlaceholder(t) {
    var e = t || window.event, r = e.target || e.srcElement;
    if ("INPUT" === r.tagName) {
        var o = r.closest("[data-input-lid]"), n = r.getAttribute("placeholder"), a = "";
...
function t_forms__addPlaceholder(t) {
    var e = t || window.event, r = e.target || e.srcElement, o = r.closest("[data-input-lid]"), n = "";
            ...
            if (o.classList.contains("t-form__inputsbox_inrow") || (n = r.querySelectorAll(".t-input-block_width")), 0 !== n.length) {
                ...
                Array.prototype.forEach.call(n, function(t) {
                    ...
                    if (o.classList.contains("t-form__inputsbox_inrow") || (e = e.closest(".t-input-group")), e && e.classList.contains("t-input-group_inrow-withsibling")) {
                        ...
                        if (!r || 0 !== n.length || !(r.classList.contains("t-input-group_inrow") && !e.classList.contains("t-input-group_widthdef") || e.classList.contains("t-input-group_widthdef") && r.classList.contains("t-input-group") && !r.classList.contains("t-input-group_inrow"))) return e.classList.remove("t-input-group_inrow-withsibling"), void e.classList.add("t-input-group_inrow-last");
                        r.classList.add("t-input-group_inonerow");
                    } else e.classList.add("t-input-group_inrow-last");
                    r && e.classList.contains("t-input-group_widthdef") && e.classList.contains("t-input-group_inrow-withsibling") && r.classList.contains("t-input-group_inonerow") && !r.classList.contains("t-input-group_inrow") && (r.classList.add("t-input-group_widthdef"), r.classList.contains("t-input-group_inrow-withsibling") || r.classList.add("t-input-group_inrow-last"), r.classList.contains("t-input-group_inrow") && e.classList.add("t-input-group_inrow-last")), o.classList.contains("t-form__inputsbox_inrow") || t_forms__calculateFieldsWidthInJS(e, a);
                });
...
function t_forms__initBtnClick(t) {
    var e = t || window.event, r = e.target || e.srcElement, o = !!r.closest('[type="submit"]') && r;
    if (o) {
        var n = o.closest(".js-form-proccess");
        if (n) {
            e.preventDefault ? e.preventDefault() : e.returnValue = !1;
            var a = n.getAttribute("id"), i, s = "";
            if (o.tildaSendingStatus && (s = o.tildaSendingStatus), !(s && s >= 1 || t_hasClass(o, "t706__submit_disable"))) {
                if (t_addClass(o, "t-btn_sending"), o.tildaSendingStatus = "1", window.tildaForm.hideErrors(n), i = window.tildaForm.validate(n), window.tildaForm.showErrors(n, i)) t_removeClass(o, "t-btn_sending"), o.tildaSendingStatus = "0";
                else {
                    var l, c = document.getElementById("allrecords").getAttribute("data-tilda-formskey"), u = parseInt(n.getAttribute("data-formactiontype")), d;
                    if (!n.querySelectorAll(".js-formaction-services").length && 1 !== u && !c) {
                        var m = t_forms__getErrorContainers(n, ""), f = m.errorBoxes, _ = m.allError;
                        ...
                        }), t_addClass(n, "js-send-form-error"), t_removeClass(o, "t-btn_sending"), o.tildaSendingStatus = "0", void t_triggerEvent(n, "tildaform:aftererror");
                    }
...
function t_asyncLoad(t) {
    var e = t.getAttribute("data-tilda-mask"), r = t.getAttribute("data-tilda-mask-holder"), o = t.getAttribute("data-tilda-mask-init");
...
window.t_forms__lang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), window.scriptSysPayment = {}, window.handlerSysPayment = {}, window.isInitEventsZB = {}, window.isInitEventsCustomMask = {}, window.initForms = {}, window.tildaForm = {
...
}, window.t_forms__clearForm = t_formsApi__clearForm, window.t_forms__updateAllVariables = t_forms__updateAllVariables, t_onReady(function() {
    ...
    if (o || n || a) {
        ...
        if (!document.head.querySelector('script[src*="' + i + '"]')) {
            ...
            s.type = "text/javascript", s.src = "https://static.tildacdn." + t_forms__getRootZone() + "/js/" + i + ".min.js", s.onerror = function() {
    ...
    for(var e = t_forms__getElement(t), r = e.querySelectorAll(".js-tilda-rule"), o = [], n = !0, a = e.getAttribute("data-formcart"), i, s = t_forms__getConditionCheckHandler(e).isHiddenByCondition, l = 0; l < r.length; l++){
        var c = r[l];
        if (!s(c)) {
            var u = !!parseInt(c.getAttribute("data-tilda-req") || 0, 10), d = c.getAttribute("data-tilda-rule") || "none", m, f, _ = c.getAttribute("data-tilda-rule-minlength") || 0, p = c.getAttribute("data-tilda-rule-maxlength") || 0, w = {}, y = c.value, v = "", h = c.getAttribute("type"), g = c.getAttribute("name");
            w.obj = c, w.type = [], y && y.length && (v = y.replace(/[\s\u0000—\u001F\u2000-\u200F\uFEFF\u2028-\u202F\u205F-\u206F]/gi, ""), y = y.trim()), _ && (_ = parseInt(_, 10)), p && (p = parseInt(p, 10));
            var b = !y.length && !v.length, E = "checkbox" === h || "radio" === h, F = e.querySelectorAll('[name="' + g + '"]:checked').length, A = c.classList.contains("t-checkboxes__hiddeninput");
            if (A || "radio" === h) {
                var x = A ? "checkbox" : "radio", S = c.closest(".t-input-block"), C = S && S.querySelector(".t-input__own-answer-input, .t-" + x + "-ownanswer");
                if (C && C.checked) {
                    var T = S.querySelector(".t-input__own-answer, .t-input-ownanswer"), k;
                    T && !T.value.trim() && (t_forms__validateOwnVariant(T), b = !0);
                }
            }
            if ((y.length && !E || E && F) && (n = !1), u && (b || E && !F)) w.type.push("req");
            else {
                switch(d){
                    case "email":
                        ...
                        break;
                    case "url":
                        m = /^((https?|ftp):\/\/)?[a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9][a-zA-Zёа-яЁА-ЯЁёäöüÄÖÜßèéûşç0-9_\.\-]{0,253}\.[a-zA-Zёа-яЁА-Я]{2,10}\/?$/gi, y.length && ((f = (f = (f = y.split("//")) && f.length > 1 ? f[1] : f[0]).split("/")) && f.length && f[0] ? (f = f[0]).match(m) || w.type.push("url") : f && !f[0] || w.type.push("url"));
                        break;
                    case "phone":
                        var I = c.getAttribute("data-tilda-mask"), L = "^[0-9()+-";
                        I && (-1 !== I.indexOf("*") ? L += "a-z\u0451\u0430-\u044F" : (-1 !== I.indexOf("a") && (L += "a-z"), -1 !== I.indexOf("\u0430") && (L += "\u0430-\u044F\u0451"))), L += "]+$", m = new RegExp(L, "gi"), (v.length && !v.match(m) || 1 == (f = v.replace(/[^0-9]+/g, "")).indexOf("000") || 1 == f.indexOf("111") && "9" != f.substring(0, 1) || 1 == f.indexOf("222") && "5" != f.substring(0, 1) || 1 == f.indexOf("333") || 1 == f.indexOf("444") || 1 == f.indexOf("5555") && "0" != f.substring(0, 1) || 1 == f.indexOf("666") && "0" != f.substring(0, 1) || 1 == f.indexOf("8888") && "4" != f.substring(0, 1)) && w.type.push("phone");
                        break;
                    case "number":
                        m = /^[0-9]+$/gi, v.length > 0 && !v.match(m) && w.type.push("number");
                        break;
                    case "date":
                        t_onFuncLoad("t_datepicker__readDateFromInput", function() {
                            var t = t_datepicker__readDateFromInput(c);
                            v.length > 0 && !window.t_datepicker__isDateValid(t) && w.type.push("date");
                        });
                        break;
                    case "time":
                        m = /^[0-9]{2}[:\.][0-9]{2}$/gi, v.length > 0 && !v.match(m) && w.type.push("time");
                        break;
                    case "name":
                    ...
                    case "chosevalue":
                        ...
                        break;
                    case "promocode":
                        "y" !== a || !v.length || !window.tcart || window.tcart.promocode && window.tcart.prodamount_discountsum || w.type.push("promocode");
                        break;
                    case "deliveryreq":
                ...
                _ > 0 && y.length && y.length < _ && w.type.push("minlength"), p > 0 && y.length && y.length > p && w.type.push("maxlength");
            }
            w.type && w.type.length && (o[o.length] = w);
        }
    }
    if ("y" === a) {
        var D = window.tcart_minorder > 0, M = window.tcart_mincntorder > 0, q;
        if (D) {
            if ((q = window.tcart.prodamount_withdiscount > 0 ? window.tcart.prodamount_withdiscount : void 0 !== window.tcart.prodamount_withdyndiscount && window.t_cart__discounts && window.t_cart__discounts.length > 0 ? window.tcart.prodamount_withdyndiscount : window.tcart.prodamount) < window.tcart_minorder) {
                var P = {
                    obj: {},
                    type: []
                };
    ...
    if ("object" != typeof t || t.length) {
        var e = t_forms__getElement(t), r = e.querySelectorAll(".js-errorbox-all"), o = e.querySelectorAll(".js-rule-error"), n = e.querySelectorAll(".js-error-rule-all"), a = e.querySelectorAll(".js-successbox"), i = e.querySelectorAll(".js-error-control-box"), s = e.querySelectorAll(".js-error-control-box .t-input-error"), l = document.getElementById("tilda-popup-for-error");
    ...
    n || (n = ".blockinput");
    var a = "", i = !1, s = !0, l, c = "", u = "", d = "", m = document.getElementById("tilda-popup-for-error"), f;
    m || (document.body.insertAdjacentHTML("beforeend", '<div id="tilda-popup-for-error" class="js-form-popup-errorbox tn-form__errorbox-popup" style="display: none;"> <div class="t-form__errorbox-text t-text t-text_xs"> error </div> <div class="tn-form__errorbox-close js-errorbox-close"> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-left"></div> <div class="tn-form__errorbox-close-line tn-form__errorbox-close-line-right"></div> </div> </div>'), t_addEventListener(m = document.getElementById("tilda-popup-for-error"), "click", function(t) {
        var e = t || window.event, r, o;
        (e.target || e.srcElement).closest(".js-errorbox-close") && (e.preventDefault ? e.preventDefault() : e.returnValue = !1, t_fadeOut(m));
    }));
    for(var _ = 0; _ < e.length; _++)if (e[_] && e[_].obj) {
        if (0 === _ && "none" === e[_].obj) {
            d = '<p class="t-form__errorbox-item">' + t_forms__getMsg("emptyfill") + "</p>";
            break;
        }
        var p = t_forms__getElement(e[_].obj);
        p && (a = p.closest(n)), a && (c = a.querySelectorAll(".t-input-error"), t_addClass(a, "js-error-control-box"), c.length && (i = !0));
        for(var w = 0; w < e[_].type.length; w++){
            var y = e[_].type[w], v = t_forms__getMsg(y);
            u = "", (l = r.querySelector(".js-rule-error-" + y)) ? l.textContent && l.innerText || !v || -1 !== d.indexOf(v) ? (u = l.textContent || l.innerText, -1 === d.indexOf(u) && (d = d + '<p class="t-form__errorbox-item">' + u + "</p>")) : d = d + '<p class="t-form__errorbox-item">' + v + "</p>" : v && -1 === d.indexOf(v) && (d = d + '<p class="t-form__errorbox-item">' + v + "</p>"), i && (!u && t_forms__getMsg(y + "field") && (u = t_forms__getMsg(y + "field")), !u && v && (u = v), u && a && (c = a.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(c, function(t) {
    ...
    if (d) {
        ...
        if (Array.prototype.forEach.call(h, function(t) {
            ...
            if (g && g.length) {
                var b, E = '.t1093 .t-popup[data-tooltip-hook="' + g[g.length - 1] + '"]', F = document.querySelector(E), A = F ? getComputedStyle(F).zIndex : 0, x;
    ...
    function S(t) {
        var e = t || window.event, r;
        if ("INPUT" === (e.target || e.srcElement).tagName && f) {
            var n = f.querySelectorAll("form .t-input-error");
            t_fadeOut(m), Array.prototype.forEach.call(n, function(t) {
    ...
    if (window.t_forms__errorTimerID && window.clearTimeout(window.t_forms__errorTimerID), window.t_forms__errorTimerID = window.setTimeout(function() {
        t_fadeOut(m), c = r.querySelectorAll(".t-input-error"), Array.prototype.forEach.call(c, function(t) {
            t.innerHTML = "", t_fadeOut(t);
        }), window.t_forms__errorTimerID = 0;
    }, 1e4), !window.isInitEventsZB[o]) {
        f = r.closest(".r");
        var C = "focus";
        document.addEventListener || (C = "focusin"), t_removeEventListener(f, C, S), t_addEventListener(f, C, S, !0), t_removeEventListener(f, "change", S), t_addEventListener(f, "change", S, !0);
    }
    ...
    for(var n, a = (r || {}).inputBoxSelector, i, s = void 0 === a ? o.getAttribute("data-inputbox") || ".blockinput" : a, l = t_forms__createErrorFocusHash(), c = 0; c < e.length; c++){
        ...
        if (d && d.obj) {
            ...
            if (f && f instanceof Element) t_forms__showInputErrors(o, f.closest(s), d);
    ...
    var t = document.getElementById("tildaformsuccesspopup-new"), e = document.getElementById("tildaformsuccesspopup"), r, o = e && "block" === getComputedStyle(e).display ? e : t;
    if (o) {
        t_removeClass(document.body, "t-body_success-popup-showed"), t_forms__isIOS() && window.tildaForm.unlockBodyScroll(), t_fadeOut(o);
    ...
    var e = "", r = document.getElementById("tildaformsuccesspopup"), o = document.getElementById("tildaformsuccesspopuptext"), n = document.body;
    if (!r) {
    ...
    o.innerHTML = t, t_fadeIn(r), t_addClass(n, "t-body_success-popup-showed"), t_forms__isIOS() && setTimeout(function() {
        window.tildaForm.lockBodyScroll();
    }, 500);
}, window.tildaForm.showSuccessPopupNew = function(t, e, r, o) {
    var n = "tildaformsuccesspopup-new", a = document.body, i = t.getAttribute("data-success-url"), s = !!i;
    if (window.isRedirectError || !s || e || r) {
        var l = window.isRedirectError && s && !e && !r, c = !r && !e, u = d();
        _(), t_forms__setupCloseHandlers(u, s), m(), setTimeout(function() {
    ...
    function m() {
        t_fadeIn(u), t_addClass(a, "t-body_success-popup-showed"), t_forms__isIOS() && setTimeout(function() {
            window.tildaForm.lockBodyScroll();
        }, 500);
    }
    function f() {
        return {
            ...
            info: {
                element: document.getElementById("tildaformsuccesspopupinfo-new"),
                content: null,
                show: s
            },
            infoText: {
    ...
    function _() {
        ...
        Object.keys(t).forEach(function(e) {
            var r = t[e], o = r.element, n = r.content, a = r.show;
    ...
    var n = o.closest(".t-popup"), a = o.closest(".t1093");
    t_forms__isNewSuccessBox(o) && n && !a && t_forms__processFormsInPopup(n, o), t_forms__showSuccessbox(o).finally(function() {
    ...
    var form = t_forms__getElement(formNode), btnSubmit = t_forms__getElement(btnSubmitNode), allRecords = document.getElementById("allrecords"), pageId = allRecords.getAttribute("data-tilda-page-id"), projectId = allRecords.getAttribute("data-tilda-project-id"), formId = form.getAttribute("id"), dataFormCart = form.getAttribute("data-formcart"), msgContainers, errorBoxes, allError;
    ...
    if (inputItsGood || form.insertAdjacentHTML("beforeend", '<div style="position: absolute; left: -5000px; bottom: 0; display: none;"><input type="text" name="form-spec-comments" value="Its good" class="js-form-spec-comments" tabindex="-1" /></div>'), 2 === formType || !formType && formKey) {
        ...
        for(var spec in tildaSpecs)hiddenInput = form.querySelector('input[name="' + spec + '"]'), hiddenInput || (form.insertAdjacentHTML("beforeend", '<input type="hidden" name="' + spec + '" value="">'), hiddenInput = form.querySelector('input[name="' + spec + '"]'), hiddenInput.value = tildaSpecs[spec]);
        try {
        ...
        var _t_forms__getFormData = t_forms__getFormData(form), status = _t_forms__getFormData.status, formData = _t_forms__getFormData.data, contentType = _t_forms__getFormData.contentType;
        if ("invalid" === status) return !1;
        var startRequest = Date.now();
        t_triggerEvent(form, "tildaform:beforesend");
        var formUrl = "https://" + window.tildaForm.endpoint + "/procces/", secondFormTypeXhr = new XMLHttpRequest;
        return secondFormTypeXhr.open("POST", formUrl, !0), secondFormTypeXhr.setRequestHeader("Content-Type", contentType), secondFormTypeXhr.setRequestHeader("Accept", "application/json, text/javascript, */*; q=0.01"), secondFormTypeXhr.onreadystatechange = function() {
                ...
                if (secondFormTypeXhr.status >= 200 && secondFormTypeXhr.status < 400) {
                    ...
                    if (data) {
                        ...
                        if ("object" == typeof objData) {
                            var dataSuccessUrl = form.getAttribute("data-success-url"), dataSuccessCallback = form.getAttribute("data-success-callback"), dataFormSendedCallback = form.getAttribute("data-formsended-callback");
                            ...
                            if (objData && objData.error) msgContainers = t_forms__getErrorContainers(form, ""), errorBoxes = msgContainers.errorBoxes, allError = msgContainers.allError, Array.prototype.forEach.call(allError, function(t) {
                                t.style.display = "block";
                                ...
                                var title = "Send data from form " + formId, price = 0, product = "", priceEl = form.querySelector(".js-tilda-price");
                    ...
                    if (t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", msgContainers = t_forms__getErrorContainers(form, ""), errorBoxes = msgContainers.errorBoxes, allError = msgContainers.allError, !secondFormTypeXhr || 0 == secondFormTypeXhr.status && tsDelta < 100) Array.prototype.forEach.call(allError, function(t) {
                        t.innerHTML = "Request error (sending form data). Please check internet connection...";
                    });
                    else {
                        if (secondFormTypeXhr && (secondFormTypeXhr.status >= 500 || 408 == secondFormTypeXhr.status || 410 == secondFormTypeXhr.status || 429 == secondFormTypeXhr.status || "timeout" == secondFormTypeXhr.statusText) && -1 !== window.tildaForm.endpoint.indexOf("forms.tilda")) return window.tildaForm.endpoint = "forms2.tildacdn.com", window.tildaForm.send(form, btnSubmit, formType, formKey), !1;
                        secondFormTypeXhr && secondFormTypeXhr.responseText ? Array.prototype.forEach.call(allError, function(t) {
                            t.innerHTML = "[" + secondFormTypeXhr.status + "] " + secondFormTypeXhr.responseText + ". Please, try again later.";
                        }) : secondFormTypeXhr && secondFormTypeXhr.statusText ? Array.prototype.forEach.call(allError, function(t) {
            ...
            return !0;
        }, secondFormTypeXhr.send(formData), !1;
    }
    if ("y" === form.getAttribute("data-is-formajax")) {
        var _t_forms__getFormData2 = t_forms__getFormData(form), _status = _t_forms__getFormData2.status, _contentType = _t_forms__getFormData2.contentType, dataForm = _t_forms__getFormData2.data;
        if ("invalid" === _status) return !1;
        var formAjaxXhr = new XMLHttpRequest;
        return formAjaxXhr.open("POST", form.getAttribute("action"), !0), formAjaxXhr.setRequestHeader("Content-Type", _contentType), formAjaxXhr.setRequestHeader("Accept", "text/plain, */*; q=0.01"), formAjaxXhr.onreadystatechange = function() {
            if (4 === formAjaxXhr.readyState) {
                if (formAjaxXhr.status >= 200 && formAjaxXhr.status < 400) {
                    var t = form.querySelector(".js-successbox"), e = form.getAttribute("data-success-url"), r = form.getAttribute("data-success-callback");
                    t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0";
                    ...
                    if (o) {
                        if ("{" == o.substring(0, 1)) {
                            ...
                            if ("object" == typeof n) {
                                ...
                                else if (n && n.error) return msgContainers = t_forms__getErrorContainers(form, "Unknown error. Please, try again later."), errorBoxes = msgContainers.errorBoxes, allError = msgContainers.allError, Array.prototype.forEach.call(allError, function(t) {
                    ...
                    var a = "/tilda/" + formId + "/submitted/", i = "Send data from form " + formId;
                    window.Tilda && "function" == typeof window.Tilda.sendEventToStatistics ? window.Tilda.sendEventToStatistics(a, i, "", 0) : "undefined" != typeof ga && "tilda" !== window.mainTracker ? ga("send", {
                        hitType: "pageview",
                        page: a,
                        title: i
                    ...
                    t_removeClass(btnSubmit, "t-btn_sending"), btnSubmit.tildaSendingStatus = "0", msgContainers = t_forms__getErrorContainers(form, ""), errorBoxes = msgContainers.errorBoxes, allError = msgContainers.allError;
                    var s = formAjaxXhr.responseText;
                    Array.prototype.forEach.call(allError, function(t) {
                        s ? t.innerHTML = s + ". Please, try again later. [" + formAjaxXhr.status + "]" : formAjaxXhr.statusText ? t.innerHTML = "Error [" + formAjaxXhr.statusText + "]. Please, try again later. [" + formAjaxXhr.status + "]" : t.innerHTML = "Unknown error. Please, try again later. [" + formAjaxXhr.status + "]", t.style.display = "block";
                    }), Array.prototype.forEach.call(errorBoxes, function(t) {
                        t.style.display = "block";
                    }), t_addClass(form, "js-send-form-error"), t_triggerEvent(form, "tildaform:aftererror");
                }
...
function t_forms__getMsg(t) {
    ...
    return e.EN = {
        ...
        success_text: "Your data has been submitted.",
        success_btn: "Done",
    ...
    }, "function" == typeof t_forms__getDict && "RU" !== r && "EN" !== r && (e = window.t_forms__getDict()), e[r] ? e[r][t] : e.EN[t];
}
function checkVerifyTildaCaptcha(t) {
    var e = t || window.event;
    if (-1 !== e.origin.indexOf(window.tildaForm.endpoint)) {
        var r = document.getElementById("js-tildaspec-captcha"), o = document.getElementById("tildaformcaptchabox");
        if ("closeiframe" == e.data) return o && t_removeEl(o), void (r && t_removeEl(r));
        var n = e.data;
        if ("object" == typeof n && (n = JSON.stringify(n), Array.isArray(window.t_jserrors) || (window.t_jserrors = []), window.t_jserrors.push({
...
function t_forms__onSuccess(t) {
    ...
    var E = document.querySelector(".t-tildalabel"), F = t_forms__isNewSuccessBox(e);
    if (m > window.scrollY || y - u < _ - 100) F || n.classList.add(h), _ > y && E && setTimeout(function() {
        t_fadeOut(E);
    }, 300);
    else {
        for(var A = 0; A < g.length; A++)if (g[A] == o) {
            b = !1;
            break;
        }
    ...
    if (x && t_forms__handleRedirect(e, x, d), 835 == o || 862 == o) {
        var S = r.querySelector(".t" + o + "__btn_prev"), C = r.querySelector(".t" + o + "__wrapper"), T = r.querySelector(".t" + o + "__quiz-form-wrapper");
...
function t_forms__handleRedirect(t, e, r) {
    ...
    if (t_forms__isNewSuccessBox(t)) {
        var n = (null == r ? void 0 : r.getAttribute("data-success-title")) || "", a = (null == r ? void 0 : r.getAttribute("data-success-message")) || "", i = Boolean(n || a);
        i && f(o = 3e3);
        var s = document.getElementById("tildaformsuccesspopuplink-new");
        s && (s.removeEventListener("click", u), s.addEventListener("click", u));
        var l = null, c = null;
        function u(t) {
            var e;
            t.preventDefault(), clearTimeout(l), d(t.currentTarget.getAttribute("href"));
        }
        function d(t) {
            window.tildaForm.handleClosePopup(), window.location.href = t;
        }
        function m() {
            window.isRedirectError = !0, t_forms__showSuccessbox(t), new MutationObserver(function(t, e) {
                (s = document.getElementById("tildaformsuccesspopuplink-new")) && (e.disconnect(), s.removeEventListener("click", u), s.addEventListener("click", u));
            }).observe(document.body, {
                childList: !0
            });
        }
        function f(t) {
            var e = document.querySelector(".t-form-success-popup__info-digit"), r = t / 1e3;
            e.textContent = r;
            var o = setInterval(function() {
                r--, e.textContent = r, r <= 0 && clearInterval(o);
            }, 1e3);
        }
        l = setTimeout(function() {
            try {
                var t = window.location.href;
                d(e), i || (window.tildaForm.handleClosePopup(), c = setTimeout(function() {
                    try {
                        window.location.href === t && m();
                    } catch (e) {
                        console.error(e);
                    }
                }, 2e3), window.location.href = e);
            } catch (r) {
                console.error(r);
            }
        }, o), window.addEventListener("pageshow", function() {
...
function t_forms__scrollBeginForm(t) {
    var e = 400, r = (window.pageYOffset || document.documentElement.scrollTop) - (document.documentElement.clientTop || 0), o = t - r, n = 0, a = 16;
    function i(t) {
        var e = t;
...
function t_forms__updateAllSystemVariables(t) {
    ...
    t_forms__getUsedVariables([
        e
    ], {
        unique: !0
    }).filter(t_forms__isSystemVariable).forEach(function(t) {
...
function t_forms__getUsedVariables(t, e) {
    ...
    var r, o = e.unique, n = Array.from(t).flatMap(function(t) {
        return Array.from(t.querySelectorAll(".t-variable-placeholder")).map(function(t) {
            return {
                name: t.getAttribute("data-variable"),
                domain: t.getAttribute("data-variable-domain")
            };
        }).filter(function(t) {
...
function t_forms__clearFormInputs(t) {
    var e = t.querySelectorAll(".t-upwidget-container__data_table_actions_remove svg"), r = t.querySelectorAll('input[type="text"]'), o = t.querySelectorAll('input[type="number"]'), n = t.querySelectorAll('input[type="email"]'), a = t.querySelectorAll('input[type="tel"], input[type="hidden"][data-tilda-rule="phone"]'), i = t.querySelectorAll("textarea");
    e.forEach(function(t) {
...
function t_forms__getSuccessBoxContent(t, e) {
    var r = t_forms__getMsg("success"), o = t.getAttribute("data-success-message"), n = {
        text: "",
        title: "",
        button: ""
    };
    return o ? n.text = o : t.textContent && t.innerText || o || !r ? n.text = t.innerHTML : n.text = r, e && (o || (n.text = ""), n.title = t.getAttribute("data-success-title") || "", n.button = t.getAttribute("data-success-btn") || ""), n;
}
...
function t_forms__handleSuccess(form, options) {
    var _ref2 = options || {}, successUrl = _ref2.successUrl, _ref2$successCallback = _ref2.successCallback, successCallback = void 0 === _ref2$successCallback ? "" : _ref2$successCallback, callback = (successCallback || "").replace("window.", "");
...
function t_forms__isNewSuccessBox(t) {
    var e, r;
    return !!t && !!t_forms__isTeam() && !t_forms__isQuiz(t) && ![
        "t396",
        "t447",
        "t651",
        "t653",
...
function t_forms__getFormData(t) {
    var e = "text/plain", r = "application/x-www-form-urlencoded; charset=UTF-8";
    try {
        var o;
        if (t_forms__shouldEnableFormAsJSON()) {
            var n = t_forms__getFormDataJSON(t), a = window.tildaForm.tildapayment && window.tildaForm.tildapayment.products, i = window.tildaForm.tildamember && Object.keys(window.tildaForm.tildamember).length > 0;
            ...
            }), a && (n.tildapayment = window.tildaForm.tildapayment), i && (n.tildamember = window.tildaForm.tildamember), {
                status: "valid",
                data: JSON.stringify(n),
                contentType: e
            });
        }
        var s, l = t_serializeArray(t).filter(function(t) {
            return -1 === t.name.indexOf("tildadelivery-");
        });
        if (window.tildaForm.tildapayment && window.tildaForm.tildapayment.products) l.push({
            name: "tildapayment",
            value: JSON.stringify(window.tildaForm.tildapayment)
        });
        else if (t.closest(".t706__orderform")) return {
            status: "invalid",
            data: "",
            contentType: ""
        };
        return window.tildaForm.tildamember && Object.keys(window.tildaForm.tildamember).length > 0 && l.push({
            name: "tildamember",
            value: JSON.stringify(window.tildaForm.tildamember)
        }), {
            status: "valid",
            data: t_forms__formData(l),
            contentType: r
        };
    } catch (c) {
        return console.error("Failed to prepare form data for process. Error:", c), {
            status: "invalid",
            data: "",
            contentType: ""
        };
...
function t_serializeArray(t) {
    for(var e = [], r = t.querySelectorAll("input, textarea, button, select"), o, n = t_forms__getConditionCheckHandler(t).isHiddenByCondition, a = 0; a < r.length; a++)if (!(!r[a].name || r[a].disabled || [
        "file",
        "reset",
        "submit",
        "button"
    ].indexOf(r[a].type) > -1 || n(r[a]))) {
        if ("select-multiple" !== r[a].type) {
            if (!([
                "checkbox",
                "radio"
            ].indexOf(r[a].type) > -1) || r[a].checked) {
        ...
        } else for(var l = r[a].options, c = 0; c < l.length; c++)l[c].selected && e.push({
            name: l[c].name,
            value: l[c].value
        });
    }
...
function t_forms__getFormDataJSON(t) {
    var e = {}, r = t.querySelectorAll("input, textarea, button, select"), o, n = t_forms__getConditionCheckHandler(t).isHiddenByCondition, a = function t(r, o) {
        Array.isArray(e[r]) || (e[r] = []), e[r].push(o);
    };
    return r.forEach(function(t) {
        var r = t.name, o = t.type, i = t.disabled, s = t.value, l = t.checked, c = t.options;
        if (r && !i && !n(t) && ![
            "file",
            "reset",
            "submit",
            ...
            } else Array.from(c || []).filter(function(t) {
                return t.selected;
            }).forEach(function(t) {
                return a(r, t.value);
            });
...
function t_forms__processFormsInPopup(t, e) {
    ...
    var n, a = "t" + e.closest(".t-rec").getAttribute("data-record-type") + "_closePopup", i = e.closest(".t-rec").id.replace("rec", "");
...
function t_forms__trapFocus(t) {
    var e = t.querySelectorAll('a, button, input:not([type="hidden"]):not(.js-form-spec-comments), select, textarea, embed, video, iframe, [tabindex="0"]'), r = e[0], o = e[e.length - 1];
    document.addEventListener("keydown", function(t) {
        if (document.body.classList.contains("t-body_popupshowed")) {
            var e = "Tab" === t.key || 9 === t.keyCode, n;
            (e || e && t.shiftKey) && (t.shiftKey && document.activeElement.classList.contains("t-popup_show") && o.focus(), "Tab" !== t.key || t.shiftKey || document.activeElement !== o || (t.preventDefault(), r.focus()), "Tab" === t.key && t.shiftKey && document.activeElement === r && (t.preventDefault(), o.focus()));
        }
    });
}

//# sourceMappingURL=page69100279.d62a4d5e.js.map
